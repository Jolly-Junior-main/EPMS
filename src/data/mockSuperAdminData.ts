...
export const MOCK_ORGANIZATIONS: Organization[] = [
  {
    ...
    name: 'Bole Medhanialem Commercial Plaza PLC',
    ...
    contactEmail: 'owner@boleplaza.et',
    ...
    primaryAdminUid: 'usr_bole_owner',
    primaryAdminName: 'Abebe Mengesha',
    primaryAdminEmail: 'owner@boleplaza.et',
    createdAt: '2025-11-15T08:00:00Z',
    lastActivityAt: '2026-08-26T14:32:00Z',
    usage: {
      buildingsCount: 1,
      unitsCount: 28,
      occupiedUnitsCount: 26,
      usersCount: 6,
      storageUsedMB: 18450,
  ...
  },
  {
    ...
    name: 'Kazanchis Business Towers S.C.',
    tradeName: 'Kazanchis Executive Towers',
    ...
    contactEmail: 'owner@kazanchistower.et',
    ...
    planTier: 'business',
    planId: 'plan_business',
    subscriptionId: 'sub_kazanchis_002',
    primaryAdminUid: 'usr_kaz_owner',
    primaryAdminName: 'Dawit Haile',
    primaryAdminEmail: 'owner@kazanchistower.et',
    createdAt: '2025-12-01T09:30:00Z',
    lastActivityAt: '2026-08-26T15:10:00Z',
    usage: {
      buildingsCount: 1,
      unitsCount: 36,
      occupiedUnitsCount: 34,
      usersCount: 8,
      storageUsedMB: 28200,
      smsSentThisMonth: 850
    }
  },
  {
    organizationId: 'org_sarbet_mall',
    name: 'Sarbet Luxury Mall Real Estate PLC',
    tradeName: 'Sarbet Mall & Suites',
    ...
    contactEmail: 'owner@sarbetmall.et',
    contactPhone: '+251 91 567 8901',
    address: 'Roosevelt St, Old Airport / Sarbet',
    city: 'Addis Ababa',
    country: 'Ethiopia',
    website: 'https://sarbetmall.et',
    status: 'active',
    planTier: 'professional',
    planId: 'plan_professional',
    subscriptionId: 'sub_sarbet_003',
    primaryAdminUid: 'usr_sar_owner',
    primaryAdminName: 'Solomon Tesfaye',
    primaryAdminEmail: 'owner@sarbetmall.et',
    createdAt: '2026-01-10T10:00:00Z',
    lastActivityAt: '2026-08-25T17:45:00Z',
    usage: {
      buildingsCount: 1,
      unitsCount: 24,
      occupiedUnitsCount: 22,
      usersCount: 5,
      storageUsedMB: 16300,
      smsSentThisMonth: 420
    }
  },
  {
    organizationId: 'org_cmc_hub',
    name: 'CMC Commercial Properties Group',
    tradeName: 'CMC Mega Hub PLC',
    ...
    contactEmail: 'owner@cmchub.et',
    contactPhone: '+251 91 789 0123',
    address: 'CMC Road, Yeka Sub-City',
    city: 'Addis Ababa',
    country: 'Ethiopia',
    website: 'https://cmchub.et',
    status: 'active',
    planTier: 'starter',
    planId: 'plan_starter',
    subscriptionId: 'sub_cmc_004',
    primaryAdminUid: 'usr_cmc_owner',
    primaryAdminName: 'Yohannes Kebede',
    primaryAdminEmail: 'owner@cmchub.et',
    createdAt: '2026-02-10T11:00:00Z',
    lastActivityAt: '2026-08-26T12:00:00Z',
    usage: {
      buildingsCount: 1,
      unitsCount: 45,
      occupiedUnitsCount: 41,
      usersCount: 7,
      storageUsedMB: 22100,
      smsSentThisMonth: 590
    }
  }
];
